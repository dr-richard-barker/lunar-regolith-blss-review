...
\begin{itemize}
    ...
    \item \textbf{Track B (Multiphase Fluid Dynamics):} Pore throat optimization ($30\text{--}60\,\mu\mathrm{m}$) conducted in terrestrial benchtop tests serves as the direct prerequisite for ISS variable-gravity centrifuge flight experiments (2026--2028), ensuring that zero-hypoxia root aeration is validated before modular hydroponic racks are integrated into habitat structures.
